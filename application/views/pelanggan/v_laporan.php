                ...
                <div class="container text-center">
                    <div class="row mb-2">
                        <div class="col-sm-12 text-center">
                            <h1 class="m-0 text-dark"> Laporan <small> pelanggan</small></h1>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td width="150px" align="center">
                                                <a href="<?= base_url('pelanggan/c_pelanggan/print_laporan/' . $psn->no_invoice) ?>" class=" btn btn-sm btn-info"><i class="fas fa-info"></i></a>
                                                <a href="<?= base_url('pelanggan/c_pelanggan/print/' . $psn->no_invoice) ?>" class=" btn btn-sm btn-warning"><i class="fas fa-print"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
