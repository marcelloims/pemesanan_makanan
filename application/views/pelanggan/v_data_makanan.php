                            ...
                            <div class="row">
                                ...
                                foreach ($makanan as $mkn) : ?>
                                    <div class="card mt-3 mr-3 ml-4" style="width: 14rem;">
                                        ...
                                        <form action="<?= base_url('pelanggan/c_pelanggan/pesan_menu_makanan/' . $mkn->kode_menu) ?>" method="post">
                                            <div class="row justify-content-center">
                                                <div class="col-5 text-center">
                                                    <input type="number" min="1" name="qty_item" class="form-control" placeholder="qty" required>
													<?php if($mkn->toping == "Ya") :?>
                                            ...
                                            <div class="card-footer text-center bg-white">
                                                <a href="<?= base_url('pelanggan/c_pelanggan/detail_makanan/' . $mkn->kode_menu) ?>" class="btn btn-sm btn-outline-info"><i class="fa fa-info-circle" aria-hidden="true"></i>Detail</a>
