<nav class="main-header navbar navbar-expand-md navbar-light navbar-white bg-info">
    <div class="container">
        <a href="#" class="navbar-brand">
            <img src="<?= base_url() ?>assets/dist/img/logo.jpg" alt="PhonePedia" class="brand-image img-circle elevation-2" style="opacity: .8">
            <span class="brand-text font-weight-light text-white"><b>BETTA MOKE </b>Indonesia</span>
        </a>
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="<?= base_url('customer/c_customer/index') ?>" class="nav-link text-white"">Home</a>
                </li>
                <li class=" nav-item">
                        <a href="<?= base_url('customer/c_customer/data_pesanan') ?>" class="nav-link text-white"">Pesanan</a>
                </li>
            </ul>
        </div>
        ...
        <ul class=" order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                <li class="nav-item mt-2">
                    <?php $cart = '<i class="fa fa-shopping-cart text-white"" aria-hidden="true"> :</i>  <b class="text-white"" id="cart">' . $this->cart->total_items() . '</b>' . '<b class="text-white"">items</b>' ?>
