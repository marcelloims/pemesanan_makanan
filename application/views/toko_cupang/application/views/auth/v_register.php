...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="<?= base_url() ?>assets/index2.html"><b>BETTA MOKE </b>Indonesia</a>
        </div>

        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg">Form Daftar Member Baru</p>
                ...
                <a href="<?= base_url('c_auth/login') ?>" class="text-center">Sudah menjadi member!</a>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
