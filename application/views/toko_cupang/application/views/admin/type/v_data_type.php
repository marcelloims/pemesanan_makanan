                                ...
                                <tbody>
                                    ...
                                    foreach ($type as $ten) : ?>
                                        <tr>
                                            ...
                                            <td align="center"><?= $ten->id_jenis ?></td>
                                            <td align="center"><?= $ten->nama_jenis ?></td>
                                            <td><?= $ten->keterangan_jenis ?></td>
                                            <td align="center">
                                                <a href="<?= base_url('admin/c_admin/edit_type/' . $ten->id_jenis) ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a href="<?= base_url('admin/c_admin/hapus_type/' . $ten->id_jenis) ?>" class="btn btn-sm btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
