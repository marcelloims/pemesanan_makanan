                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode_tenant" class="form-control" id="kodeTenant" placeholder="ID Member" value="<?= $detail['kode_tenant'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-8">
                                        <div class="form-group">
                                            <label for="">Nama Tenant</label>
                                            <input type="text" name="kode_tenant" class="form-control" id="kodeTenant" placeholder="Nama Member" value="<?= $detail['nama_tenant'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="">Telepon</label>
                                            <input type="text" name="telepon" class="form-control" id="telepon" placeholder="Telepon" value="<?= $detail['telepon_tenant'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">Email</label>
                                            <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?= $detail['email_tenant'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="">Fax</label>
                                            <input type="text" name="fax" class="form-control" id="telepon" placeholder="Fax" value="<?= $detail['fax'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="">Alamat</label>
                                            <textarea name="alamat" id="alamat" cols="30" rows="5" class="form-control" readonly><?= $detail['alamat_tenant'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <h3>Pemilik Tenant</h3>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
