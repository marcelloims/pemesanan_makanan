                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_unit" class="form-control" id="kodeUnit" placeholder="Kode Unit" value="<?= $edit['id_unit'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">Nama Unit</label>
                                        <input type="text" name="nama_unit" class="form-control" id="idUnit" placeholder="Nama Unit" value="<?= $edit['nama_unit'] ?>">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
