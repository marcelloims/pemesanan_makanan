                                ...
                                <tbody>
                                    ...
                                    foreach ($unit as $ten) : ?>
                                        <tr>
                                            ...
                                            <td align="center"><?= $ten->id_unit ?></td>
                                            <td align="center"><?= $ten->nama_unit ?></td>
                                            <td><?= $ten->keterangan_unit ?></td>
                                            <td align="center">
                                                <a href="<?= base_url('admin/c_admin/edit_unit/' . $ten->id_unit) ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a href="<?= base_url('admin/c_admin/hapus_unit/' . $ten->id_unit) ?>" class="btn btn-sm btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
