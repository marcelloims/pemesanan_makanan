                    ...
                    <div class="container-fluid">
                                ...
                                <div class="small-box bg-white">
                                    <div class="inner">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr align="center">
                                                <td>INV-<?= $pesanan->no_transaksi ?></td>
                                            ...
                                            ?>
                                                <tr align="center">
                                                    ...
                                                    <td><?= $items['qty'] ?></td>
                                                    <td colspan="3">Rp. <?= number_format($subtotal, 0, ',', '.') ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <tr>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="small-box bg-white">
                                    <?php if ($pesanan->status == "In Process") : ?>
                                        <div class="row justify-content-center text-center">
                                            <div class="col-4 mt-3 mb-3 text-success">
                                                <h6>In Process <i class="fas fa-check-circle"></i></h6>
                                            </div>
                                            <div class="col-4 mt-3 mb-3">
                                                <h6>Delevery <i class="fas fa-check-circle"></i></h6>
                                            </div>
                                            <div class="col-4 mt-3 mb-3">
                                                <h6>Receviced <i class="fas fa-check-circle"></i></h6>
                                            </div>
                                        </div>
                                    <?php elseif ($pesanan->status == "Delevery") : ?>
                                        <div class="row justify-content-center text-center">
                                            <div class="col-4 mt-3 mb-3 text-success">
                                                <h6>In Process <i class="fas fa-check-circle"></i></h6>
                                            </div>
