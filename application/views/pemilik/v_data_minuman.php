					...
					<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="<?= base_url() ?>pemilik/c_pemilik/tambah_minuman" method="POST" enctype="multipart/form-data">
							...
							?>
								<tr>
									...
									<td width="150px" align="center">
										<a href="<?= base_url('pemilik/c_pemilik/detail_minuman/' . $mmn->kode_menu) ?>" class=" btn btn-sm btn-info"><i class="fas fa-info-circle"></i></a>
										<a href="<?= base_url('pemilik/c_pemilik/edit_minuman/' . $mmn->kode_menu) ?>" class=" btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
										<a href="<?= base_url('pemilik/c_pemilik/delete_minuman/' . $mmn->kode_menu) ?>" class=" btn btn-sm btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
