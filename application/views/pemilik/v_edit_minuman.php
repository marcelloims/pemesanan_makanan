            ...
            <section class="content">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <form action="<?= base_url() ?>pemilik/c_pemilik/update_minuman" method="POST" enctype="multipart/form-data">
                                ...
                                <?php echo anchor('pemilik/c_pemilik/data_minuman/', '<div class="btn btn-sm btn-danger float-right">Kembali</div>') ?>
                            </form>
                        </div>
                    </div>
                </div>
