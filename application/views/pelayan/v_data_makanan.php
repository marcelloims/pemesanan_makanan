                ...
                <div class="container text-center">
                    <div class="row mb-2">
                        <div class="col-sm-12 text-center">
                            <h1 class="m-0 text-dark"> Menu <small>Foods</small></h1>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                foreach ($makanan as $mkn) : ?>
                                    <div class="card mt-3 mr-3 ml-4" style="width: 14rem;">
                                        ...
                                        <div class="card-body text-center">
                                            <h5 class="card-title-center text-blue"><?= $mkn->nama_menu; ?></h5>
                                        ...
                                        <div class="card-footer text-center bg-white">
                                            ...
                                            <?php if ($mkn->status != 'Kosong') : ?>
                                                <?= anchor('pelayan/c_pelayan/pesan_menu_makanan/' . $mkn->kode_menu, '<div class="btn btn-sm btn-success"><i class="fa fa-usd" aria-hidden="true"></i> Pesan</div>') ?>
                                            <?php else : ?>
