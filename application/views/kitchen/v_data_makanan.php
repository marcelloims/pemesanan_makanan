					...
					<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="<?= base_url() ?>kitchen/c_kitchen/tambah_makanan" id="form" method="POST" enctype="multipart/form-data">
							...
							?>
								<tr>
									...
									<td width="150px" align="center">
										<a href="<?= base_url('kitchen/c_kitchen/detail_makanan/' . $mkn->kode_menu) ?>" class=" btn btn-sm btn-info"><i class="fas fa-info-circle"></i></a>
										<a href="<?= base_url('kitchen/c_kitchen/edit_makanan/' . $mkn->kode_menu) ?>" class=" btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
										<a href="<?= base_url('kitchen/c_kitchen/delete_makanan/' . $mkn->kode_menu) ?>" class=" btn btn-sm btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
